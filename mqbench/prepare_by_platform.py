...
ParamsTable = {
    BackendType.Academic:   dict(qtype='affine',     # noqa: E241
                                 ...
                                 a_qscheme=QuantizeScheme(symmetry=False, per_channel=False, pot_scale=False, bit=4),
    ...
    BackendType.Tensorrt:   dict(qtype='affine',     # noqa: E241
                                 w_qscheme=QuantizeScheme(symmetry=True, per_channel=True, pot_scale=False, bit=4, symmetric_range=True),
                                 a_qscheme=QuantizeScheme(symmetry=True, per_channel=False, pot_scale=False, bit=4, symmetric_range=True),
                                 default_weight_quantize=LearnableFakeQuantize,
                                 default_act_quantize=LearnableFakeQuantize,
                                 default_weight_observer=MinMaxObserver,
                                 default_act_observer=EMAMinMaxObserver),
...
FakeQuantizeDict = {
    ...
    'LearnableWeightFakeQuantize': LearnableWeightFakeQuantize,  # Learnable scale/zeropoint    # noqa: E241
